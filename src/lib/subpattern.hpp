...
void refine_recursive(cv::Mat &img, std::vector<Corner> corners, std::vector<Corner> &corners_out, int depth, double *size, cv::Mat *paint, bool *mask_2x2, int page, const cv::Rect &limit, int flags = KEEP_ALL_LEVELS);
